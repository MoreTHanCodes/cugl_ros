#ifndef __CUGL_APPS_DYNFU_EVAL_H__
#define __CUGL_APPS_DYNFU_EVAL_H__
...
namespace dynfu
{
class DynfuEval : public cugl::VisualizerBase
{
 public:
  DynfuEval(unsigned int refresh_delay = 33,
...
#endif /* __CUGL_APPS_DYNFU_EVAL_H__ */
